...
例えば、Springを使って開発していた時、「いつもgetters/settersを定義する理由は何でしたっけ？」が理解できず、調査してみました。結果、JavaBeanの誕生からServlet、EJB、ORM等々Javaエコシステムの歴史と発展を分かって、ついにPOJO、DTO、Beanなどの概念を把握できるようになりました。Java言語についてより深い理解を習得しました。
