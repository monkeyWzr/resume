...
将来はWEBアプリケーションエンジニアとしてモダンな開発を中心に、技術を活用することで、大規模なサービスから生み出した課題を挑戦できる仕事をやりたいと思います！そして、プログラミング言語の本質、ソフトウェア開発方法論などに凄く興味がありますので、チャンスがあればソフトウェア工学を目指して大学院に進学したいと思います。（お金とか、入学試験とかは大問題）
